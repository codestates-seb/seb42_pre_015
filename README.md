...
|<p align="left">**Pages**<br/>-  Question detail page<br/>- Ask question page <br/>**Components**<br/>-  Navigation <br/>- Tag <br/>- Editor <br/>**Features**<br/>-  Question CRD<br/>- Answer CRD <br/> - Comment CRD  <br/>- Vote CD <br/></p> | <p align="left">**Pages**<br/>-  Main page<br/>- Edit Question page<br/>- Edit Answer page<br/>**Components**<br/>-  Header <br/>- Side navigation <br/>**Features**<br/>-  Question RU<br/>- Answer U <br/> - Search by <br/>keywords, tags <br/>and username  <br/></p> |<p align="left">**Pages**<br/>-  Signup page<br/>- Login page <br/>**Components**<br/>-  Buttons <br/>- Footer <br/>**Features**<br/>-  Email signup<br/>-  Email login<br/> logout <br/> - Manage access <br/>and refresh token  <br/></p> | <p align="left"><br/>-Signup (User registration)<br/>- Automated welcome email<br/>\- Spring Security (Authentication, Authorization, JWT)<br/>-Search implementation<br/>\- AWS deployment<br/> | <p align="left">- CRUD<br/>- Answer, Comment<br/>- Exception handling<br/> 기능 구현<br/>답변 투표 실행<br/>- 취소 기능<br/> | <p align="left">- CRUD<br/>-질문,댓글<br/>-TAG 등록 구현 <br/>-검색 기능 구현<br/>-투표 기능 구현<br/>-배포 환경 구성 <br/> |
